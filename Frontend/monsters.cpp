...
void monstersBegin() {
	...
	earthOne = createMonsterTemplate(EARTH_ONE, earthOneVerts, 20.0f, vec3(EARTH_ONE_SCALE)); // mouse thing
	// earth two
	...
	earthTwo = createMonsterTemplate(EARTH_TWO, earthTwoVerts, 80.0f, vec3(EARTH_TWO_SCALE)); // punchy boi
	getMonsters();
}
